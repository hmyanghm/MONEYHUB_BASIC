...
compo_vue ={
	...
	compo_body : ()=>{
		...
		'				<div>'+
		'					<h2>머니허브 회사 소개</h2>'+
		'					<p style="padding-top: 25px;">머니허브은 최적의 해외송금 솔루션을 제공하는 핀테크 회사입니다. 2016년 3월 법인 설립을 시작으로 합리적인 가격으로 빠르고 편리한 송금 서비스를 제공하고 있습니다.'+
		'						<br>'+
		'						머니허브은 비효율을 혁신적으로 해결하고, 사람을 위한 가치를 창출하고자 하며, 무엇보다도 고객의 돈을 안전하게 보내는 것을 최우선으로 합니다.'+
		'						<br><br>'+
		'						<span>머니허브은 2019년 6월 기준, 일본/중국/미국/싱가포르/호주/영국 송금 서비스를 제공하고 있으며, 동남아시아, 유럽 등을 목표로 서비스를 확장할 예정입니다. 앞으로도 머니허브은 해외송금 서비스에 대한 끊임없는 연구를 통해 고객들에게 더 편리한 서비스를 제공할 수 있도록 노력하겠습니다.</span>'+
		'					</p>'+
		'				</div>'+
		'			</div>'+
		'		</div>'+
		...
		'					<p>'+
		'					이것이 머니허브을 설립한 이유입니다. 우리는 모두가 안심하고 만족하는 서비스를 제공하도록 노력할 것이며 해외 송금 시장을 더 나은 방향으로 변화시키려 합니다.'+
		'					</p>'+
		'				</div>'+
		'			</div>'+
		'		</div>'+
		...
		'	<div>'+
		'		<h1>'+
		'			<span class="blue">머니허브은 솔직하고</span>투명합니다.'+
		'		</h1>'+
		'	</div>'+
		'</div>'+
		'<div class="divider"></div>'+
		...
		'	<div>'+
		'		<img class="logo" src="https://img.themoin.com/public/img/img-grid-logo.svg">'+
		'		<div class="spacer"></div>'+
		'		<div>'+
		'			<br>'+
		'			<p>머니허브은 해외송금 시장을 더 나은 방향으로 이끌어가고자 하는 신념과 동시에,'+
		'				<br>'+
		'				고객들에게 신뢰할 수 있는 서비스를 제공하고자 하는 철학을 담고 있습니다.'+
		'				<br>'+
		'				머니허브 CI의 ‘머니허브 스퀘어’과 ‘머니허브 라운드’가 만나는 부분에서의 직선으로 연결된 모습은 연결과 해결책을 상징하며, 머니허브의 굵고 올바른 고딕 형태의 문자는 빠르게 나아가는 머니허브의 진취성과 기술적 혁신을 담고 있습니다.'+
		'				<br>'+
		'			</p>'+
		'			<p>'+
		...
		'				<span class="blue">MONEYHUB BLUE</span>'+
		'				&nbsp;&nbsp;'+
		...
		'	<div>'+
		'		<h1>'+
		'			<span class="blue">머니허브은 언제나</span>'+
		'			 열려있습니다.'+
		'		</h1>'+
		'	</div>'+
		'</div>'+
